...
const AboutPage = () => {
  ...
  const statsData = useMemo(() => [
    ...
    },
    {
      ...
      label: "Certificates",
      description: "Professional Validated.",
      animation: "fade-up",
    },
    {
      icon: Globe,
      ...
      description: "All About My Journey.",
      animation: "fade-left",
    },
  ...
  return (
    <div
      className="h-auto pb-[10%] text-white overflow-hidden px-[5%] sm:px-[5%] lg:px-[10%] pt-28 md:pt-10"
      id="About"
    >
      <Header />
